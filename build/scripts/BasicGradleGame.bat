...
@rem ##########################################################################
@rem
@rem  BasicGradleGame startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and BASIC_GRADLE_GAME_OPTS to pass JVM options to this script.
...
:fail
rem Set variable BASIC_GRADLE_GAME_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%BASIC_GRADLE_GAME_EXIT_CONSOLE%" exit 1
exit /b 1
